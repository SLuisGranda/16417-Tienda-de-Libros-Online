         ...
         if (menu.equals("AdminTI")) {
             ...
             switch (accion) {
                ...
                case "Agregar":
                    ...
                    usuario.setEstado(estado);
                    usuarioDAO.Agregar(usuario);
                    request.getRequestDispatcher("Controlador?menu=AdminTI&accion=Listar").forward(request, response);
            ...
            request.getRequestDispatcher("AdminTI.jsp").forward(request, response);
        }
